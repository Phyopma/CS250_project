...
// Print the course by using all the get functions.
    cout << "java: " << "CS A" << java.getCourseNumber() << " ";
    cout << java.getCourseName() << " ";
    cout << java.getCourseUnits() << " ";
...
// has all new values.
    cout << "\njava: " << "CS A" << java.getCourseNumber() << " ";
    cout << java.getCourseName() << " ";
    cout << java.getCourseUnits() << " ";
    for (int i: java.getCoursePrereqs()) {
        cout << i << " ";
...
// You can use as a fourth parameter the call: set<int>{150, 170}
    ...
    cout << "\ncpp: " << "CS A" << cpp.getCourseNumber() << " ";
    cout << cpp.getCourseName() << " ";
    cout << cpp.getCourseUnits() << " ";
...
// Print "aCourse" to make it is an exact copy of "java".
    cout << "\naCourse: ";
    cout << "CS A" << aCourse.getCourseNumber() << " ";
    cout << aCourse.getCourseName() << " ";
    cout << aCourse.getCourseUnits() << " ";
...
// Print "java".
    cout << "\njava: ";
    cout << "CS A" << java.getCourseNumber() << " ";
    cout << java.getCourseName() << " ";
    cout << java.getCourseUnits() << " ";
    for (int i: java.getCoursePrereqs()) {
        cout << i << " ";
